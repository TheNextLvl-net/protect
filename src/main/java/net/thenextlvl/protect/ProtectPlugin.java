...
import net.thenextlvl.protect.adapters.other.FlagsAdapter;
import net.thenextlvl.protect.adapters.other.KeyAdapter;
import net.thenextlvl.protect.adapters.other.LocationAdapter;
import net.thenextlvl.protect.adapters.other.MembersAdapter;
import net.thenextlvl.protect.adapters.other.WeatherTypeAdapter;
import net.thenextlvl.protect.adapters.other.WorldAdapter;
