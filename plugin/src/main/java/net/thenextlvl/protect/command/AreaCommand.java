    ...
    public void register() {
        plugin.getLifecycleManager().registerEventHandler(LifecycleEvents.COMMANDS.newHandler(event ->
                event.registrar().register(Commands.literal("area")
                        ...
                        .then(new AreaFlagCommand.Info(plugin).create())
                        .then(new AreaFlagCommand.List(plugin).create())
                        .then(new AreaFlagCommand.Set(plugin).create())
                        .then(new AreaFlagCommand.Unset(plugin).create())
                        ...
                        .then(new AreaSchematicCommand.Delete(plugin).create())
                        .then(new AreaSchematicCommand.Load(plugin).create())
                        .then(new AreaSchematicCommand.Save(plugin).create())
