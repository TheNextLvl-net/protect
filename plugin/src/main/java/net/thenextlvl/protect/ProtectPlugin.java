...
public class ProtectPlugin extends JavaPlugin {
    ...
    public class Flags {
        ...
        public final Flag<Boolean> armorWashing = flagRegistry().register(ProtectPlugin.this, "armor_washing", true, false);
        public final Flag<Boolean> bannerWashing = flagRegistry().register(ProtectPlugin.this, "banner_washing", true, false);
        public final Flag<Boolean> blockAbsorb = flagRegistry().register(ProtectPlugin.this, "block_absorb", true, false);
        public final Flag<Boolean> blockBreak = flagRegistry().register(ProtectPlugin.this, "block_break", true, false);
        public final Flag<Boolean> blockBurning = flagRegistry().register(ProtectPlugin.this, "block_burning", true, false);
        public final Flag<Boolean> blockDrying = flagRegistry().register(ProtectPlugin.this, "block_drying", true, false);
        public final Flag<Boolean> blockFading = flagRegistry().register(ProtectPlugin.this, "block_fading", true, false);
        public final Flag<Boolean> blockFertilize = flagRegistry().register(ProtectPlugin.this, "block_fertilize", true, false);
        public final Flag<Boolean> blockForming = flagRegistry().register(ProtectPlugin.this, "block_forming", true, false);
        public final Flag<Boolean> blockGrowth = flagRegistry().register(ProtectPlugin.this, "block_growth", true, false);
        public final Flag<Boolean> blockIgniting = flagRegistry().register(ProtectPlugin.this, "block_igniting", true, false);
        public final Flag<Boolean> blockMoisturising = flagRegistry().register(ProtectPlugin.this, "block_moisturising", true, false);
        public final Flag<Boolean> blockPlace = flagRegistry().register(ProtectPlugin.this, "block_place", true, false);
        public final Flag<Boolean> blockSpread = flagRegistry().register(ProtectPlugin.this, "block_spread", true, false);
        public final Flag<Boolean> cauldronEvaporation = flagRegistry().register(ProtectPlugin.this, "cauldron_evaporation", true, false);
        public final Flag<Boolean> cauldronExtinguishEntity = flagRegistry().register(ProtectPlugin.this, "cauldron_extinguish_entity", true, false);
        public final Flag<Boolean> cauldronLevelChangeUnknown = flagRegistry().register(ProtectPlugin.this, "cauldron_level_change_unknown", true, false);
        public final Flag<Boolean> cropTrample = flagRegistry().register(ProtectPlugin.this, "crop_trample", true, false);
        public final Flag<Boolean> damage = flagRegistry().register(ProtectPlugin.this, "damage", true);
        public final Flag<Boolean> emptyBottle = flagRegistry().register(ProtectPlugin.this, "empty_bottle", true, false);
        public final Flag<Boolean> emptyBucket = flagRegistry().register(ProtectPlugin.this, "empty_bucket", true, false);
        public final Flag<Boolean> entityAttackEntity = flagRegistry().register(ProtectPlugin.this, "entity_attack_entity", true, false);
        public final Flag<Boolean> entityAttackPlayer = flagRegistry().register(ProtectPlugin.this, "entity_attack_player", true, false);
        public final Flag<Boolean> entityInteract = flagRegistry().register(ProtectPlugin.this, "entity_interact", true, false);
        ...
        public final Flag<Boolean> entityPlace = flagRegistry().register(ProtectPlugin.this, "entity_place", true, false);
        public final Flag<Boolean> entityShear = flagRegistry().register(ProtectPlugin.this, "entity_shear", true, false);
        public final Flag<Boolean> explosions = flagRegistry().register(ProtectPlugin.this, "explosions", true, false);
        public final Flag<Boolean> fillBottle = flagRegistry().register(ProtectPlugin.this, "fill_bottle", true, false);
        public final Flag<Boolean> fillBucket = flagRegistry().register(ProtectPlugin.this, "fill_bucket", true, false);
        ...
        public final Flag<Boolean> interact = flagRegistry().register(ProtectPlugin.this, "interact", true, false);
        public final Flag<Boolean> leavesDecay = flagRegistry().register(ProtectPlugin.this, "leaves_decay", true, false);
        public final Flag<Boolean> liquidFlow = flagRegistry().register(ProtectPlugin.this, "liquid_flow", true);
        public final Flag<Boolean> naturalCauldronFill = flagRegistry().register(ProtectPlugin.this, "natural_cauldron_fill", true, false);
        public final Flag<Boolean> naturalEntitySpawn = flagRegistry().register(ProtectPlugin.this, "natural_entity_spawn", true);
        public final Flag<Boolean> physicalInteract = flagRegistry().register(ProtectPlugin.this, "physical_interact", true, false);
        public final Flag<Boolean> physics = flagRegistry().register(ProtectPlugin.this, "physics", true);
        public final Flag<Boolean> playerAttackEntity = flagRegistry().register(ProtectPlugin.this, "player_attack_entity", true, false);
        public final Flag<Boolean> playerAttackPlayer = flagRegistry().register(ProtectPlugin.this, "player_attack_player", true, false);
        public final Flag<Boolean> playerItemDrop = flagRegistry().register(ProtectPlugin.this, "player_item_drop", true, false);
        ...
        public final Flag<Boolean> shulkerWashing = flagRegistry().register(ProtectPlugin.this, "shulker_washing", true, false);
    }
}
