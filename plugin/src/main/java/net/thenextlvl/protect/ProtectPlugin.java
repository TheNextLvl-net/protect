...
public class ProtectPlugin extends JavaPlugin {
    ...
    public class Flags {
        ...
        public final ProtectionFlag<Boolean> blockBreak = flagRegistry().register(ProtectPlugin.this, "block_break", true, false);
        ...
        public final ProtectionFlag<Boolean> blockPlace = flagRegistry().register(ProtectPlugin.this, "block_place", true, false);
