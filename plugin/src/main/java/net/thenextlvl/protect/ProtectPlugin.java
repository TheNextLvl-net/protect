...
public class ProtectPlugin extends JavaPlugin {
    ...
    public class Flags {
        ...
        public final Flag<Boolean> damage = flagRegistry().register(ProtectPlugin.this, Boolean.class, "damage", true);
        ...
        public final Flag<Boolean> liquidFlow = flagRegistry().register(ProtectPlugin.this, Boolean.class, "liquid_flow", true);
        ...
        public final Flag<Boolean> physics = flagRegistry().register(ProtectPlugin.this, Boolean.class, "physics", true);
        ...
        public final Flag<Boolean> redstone = flagRegistry().register(ProtectPlugin.this, Boolean.class, "redstone", true);
        public final Flag<Boolean> shoot = flagRegistry().register(ProtectPlugin.this, Boolean.class, "shoot", true);
